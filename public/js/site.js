...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_select__ = __webpack_require__(9);
...
var site = new Vue({
    ...
    methods: {
        ...
        search: __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.debounce(function (loading, search, vm) {
            fetch('/api/collections/movies/entries?filter[title:contains]=' + escape(search)).then(function (res) {
                res.json().then(function (json) {
                    return vm.options = json.data;
                });
                loading(false);
            });
        }, 350)
